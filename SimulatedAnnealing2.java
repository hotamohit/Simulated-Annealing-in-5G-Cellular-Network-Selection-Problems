...
public class SimulatedAnnealing2 extends Frame{
	...
	public static void main(String[] args) {
		...
		SimulatedAnnealing2 sa = new SimulatedAnnealing2();
	...
	public void annealing() {
		...
		double T = 3000, k0 = Math.pow(10, -5); //T is temperature, k0 is Boltzmann's constant
		double probability;
		int accept = 0;
